                                                                        ...
                                                                        <div className=''>
                                                                           
                                                                             {
                                                                                    ...
                                                                                    <div className='flex justify-center flex-col'>
                                                                                        ...
                                                                                        <h3 className='text-lg'>1 {foodRanking[0].name} <span><Rate max={1} size='sm' color='yellow' readOnly defaultValue={1}/>{foodRanking[0].averageRating.toFixed(2)}</span></h3>
                                                                                    </div>
                                                                             }
                                                                        </div>
                                                                ...
                                                                <div className=''>
                                                                           
                                                                           {
                                                                                  ...
                                                                                  <div className='flex justify-center flex-col'>
                                                                                      ...
                                                                                      <h3 className='text-lg'>2 {foodRanking[1].name} <span><Rate max={1} size='sm' readOnly defaultValue={1} color='yellow'/>{foodRanking[1].averageRating.toFixed(2)}</span></h3>
                                                                                  </div>
                                                                           }
                                                                      </div>
                                                                      <div className=''>
                                                                           
                                                                           {
                                                                                  ...
                                                                                  <div className='flex justify-center flex-col'>
                                                                                      ...
                                                                                      <h3 className='text-lg'>3 {foodRanking[2].name} <span><Rate max={1} size='sm' color='yellow' readOnly defaultValue={1}/>{foodRanking[2].averageRating.toFixed(2)}</span></h3>
                                                                                  </div>
                                                                           }
                                                                      </div>
                                                                </div>
